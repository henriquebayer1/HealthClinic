        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HorarioDeFuncionamento = table.Column<string>(type: "VARCHAR(100)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "AgendamentosConsulta",
                columns: table => new
                {
                    IdAgendamentoConsulta = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DataConsulta = table.Column<DateTime>(type: "DATE", nullable: false),
                    HorarioConsulta = table.Column<TimeSpan>(type: "TIME(7)", nullable: false),
                    IdPaciente = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdMedico = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgendamentosConsulta", x => x.IdAgendamentoConsulta);
                    table.ForeignKey(
                        name: "FK_AgendamentosConsulta_Medico_IdMedico",
                        column: x => x.IdMedico,
                        principalTable: "Medico",
                        principalColumn: "IdMedico",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AgendamentosConsulta_Paciente_IdPaciente",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescricaoConsulta = table.Column<string>(type: "VARCHAR(100)", nullable: false),
                    IdPaciente = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdMedico = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdClinica = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdProntuario = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescricaoComentario = table.Column<string>(type: "VARCHAR(100)", nullable: false),
                    IdUsuario = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdConsulta = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgendamentosConsulta_IdMedico",
                table: "AgendamentosConsulta",
                column: "IdMedico");

            migrationBuilder.CreateIndex(
                name: "IX_AgendamentosConsulta_IdPaciente",
                table: "AgendamentosConsulta",
                column: "IdPaciente");
